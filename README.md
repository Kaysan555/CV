...
- ベンダーロックインを回避した計量設備のリプレースプロジェクト（業者との合意形成および工程管理を一括して担当）

#### 不燃物燃料化プラント管理業務（2年間・プラント寿命10年超過）
...
- 公共施設予約管理システム、地理情報空間システム、燃料計量管理システムの更新プロジェクト
