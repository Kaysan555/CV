...
また、GIF（政府相互運用性フレームワーク）に関してはyoutube等で情報収集経験があります、GIFからの情報収集がスタートではなくCityOSやデータレイク構築の概念から共通ルールに基づいたデータ規格作成に関する基本的に必要なフレームと理解しています。また、IPAで公開している関連資料などを再度学習したいと思っています。  
